...
const Home = () => {
  ...
  const fetchPosts = async () => {
    ...
    try {
      const response = await fetch('https://imageforge-nbmn.onrender.com/api/v1/post', {
        method: 'GET',
        headers: {
  ...
  return (
    <>
      <Hero/>
      <section className="max-w-7xl bg-white/10  lg:px-6 lg:py-6 p-4 rounded-3xl mx-auto ">
      <div>
